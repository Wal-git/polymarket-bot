...
class SpotPrices:
    """Spot prices for a single asset from multiple exchanges. Any field may
    be None when that source failed; callers should use ``exchange_prices()``
    to iterate only the available ones."""
...
class FuturesSnapshot:
    """Binance Futures premium index snapshot for one perp symbol."""
    mark_price: float
    index_price: float
